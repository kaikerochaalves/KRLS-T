...
l_M = [25, 50, 75, 100, 150, 200]
l_sigma = [0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 1, 5, 10]
l_lambda1 = [0.9, 0.95, 0.999]
l_epsilon = [1e-6, 1e-4, 1e-2]
l_sn2 = [1e-6, 1e-4, 1e-2]
...
columns = ['M', 'sigma', 'lambda1', 'epsilon', 'sn2', 'RMSE', 'NDEI', 'MAE']
        ...
        for lambda1 in l_lambda1:
            for epsilon in l_epsilon:
                for sn2 in l_sn2:
                    ...
                    print(f"M = {M} and sigma = {sigma} and lambda1 = {lambda1} and epsilon = {epsilon} and sn2 = {sn2}")
                
                    # Initializing the model
                    model = KRLS_T(M = M, sigma = sigma, lambda1 = lambda1, epsilon = epsilon, sn2 = sn2)
                    # Train the model
                    ...
                    NewRow = pd.DataFrame([[M, sigma, lambda1, epsilon, sn2, RMSE, NDEI, MAE]], columns = columns)
